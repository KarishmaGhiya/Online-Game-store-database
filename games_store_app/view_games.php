...
$query = "SELECT Games_id, games_name,min_memory_size, max_no_players, games.details,console_fk, drive_type ,price FROM games, Product, consoles WHERE games.Games_id = Product.Product_id  AND consoles.console_id = games.console_fk ORDER BY $order_by LIMIT $start, $display";
